...
INSERT INTO `django_admin_log` VALUES (1,'2024-05-20 08:15:45.379992','1','Model1 object (1)',1,'[{\"added\": {}}]',7,2),(2,'2024-05-20 08:15:57.586201','1','Model 1 with name 1',1,'[{\"added\": {}}]',8,2),(3,'2024-05-20 08:16:07.579192','2','Model 1 with name 1',1,'[{\"added\": {}}]',8,2),(4,'2024-05-20 08:16:17.116632','3','Model 1 with name 1',1,'[{\"added\": {}}]',8,2);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(7,'vagnertest','model1'),(8,'vagnertest','photoesmodel1');
...
INSERT INTO `vagnertest_model1` VALUES (1,'Model 1 with name 1');
/*!40000 ALTER TABLE `vagnertest_model1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vagnertest_photoesmodel1`
--

DROP TABLE IF EXISTS `vagnertest_photoesmodel1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vagnertest_photoesmodel1` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vagnertest_photoesmodel1`
--

LOCK TABLES `vagnertest_photoesmodel1` WRITE;
/*!40000 ALTER TABLE `vagnertest_photoesmodel1` DISABLE KEYS */;
INSERT INTO `vagnertest_photoesmodel1` VALUES (1,'photoes/crab.jpeg',1),(2,'photoes/crab2.jpg',1),(3,'photoes/crab3.jpg',1);
/*!40000 ALTER TABLE `vagnertest_photoesmodel1` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-05-20 18:02:30
